    ...
    <form method="POST" action="../../api/controllers/StudentController.php" id="registerFormByAdmin" class="space-y-4">
          ...
          <div class="space-y-8">
                ...
                <div>
                  ...
                  <select name="program" id="program" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    <option selected>Choisir une filière</option>
                    <option value="Developpement d /'/ application">Developpement d'application</option>
                    <option value="Secrétariat bureautique">Secrétariat bureautique</option>
                    <option value="Secrétariat comptable">Secrétariat comptable</option>
                    <option value="Maintenance des réseaux">Maintenance des réseaux</option>
                    <option value="Graphisme de production">Graphisme de production</option>
          ...
          <div class="justify-between flex text-sm font-meduim">
              ...
              <input value="Enregister" type="submit" name="addStudent" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus-ring cursor-pointer ">
         </div>
    </form>
    </div>
</div>
...
<!-- body -->
    <div  class="p-4 md:p-5">
        <form method="POST" action="../../api/controllers/StudentController.php" id="registerFormByAdmin" class="space-y-4">
              ...
              <div class="space-y-8">
                    <div>
                         <input type="text" id="updateStudentById" name="updateStudentById" class="text-white">
                    ...
                    <div>
                      ...
                      <select name="program" id="updateStudentProgram" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        <option selected>Choisir une filière</option>
                        <option value="Developpement d'application">Developpement d'application</option>
                        <option value="Secrétariat bureautiquet">Secrétariat bureautique</option>
                        <option value="Secrétariat comptable">Secrétariat comptable</option>
                        <option value="Secrétariat comptable">Maintenance des réseaux</option>
                        <option value="Secrétariat comptable">Graphisme de production</option>
