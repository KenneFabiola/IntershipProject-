...
<!-- body -->
    <div  class="p-4 md:p-5">
    <form method="POST" action="../../api/controllers/UserController.php" id="" class="space-y-4">
          ...
          <div class="space-y-8">
                ...
                <div>
                  ...
                  <select name="role_name" id="role" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
