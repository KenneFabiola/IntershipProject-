...
<div class="bg-white p-6 rounded-lg shadow-lg max-w-md w-full justify-between">
    ...
    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
        ...
        <button type="button" id="closeAddModal" class="end-2.5 text-gray-700 bg-transparent  rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center hover:bg-blue-gray-900:text-white">
...
<!-- body -->
    ...
    <form method="POST" action="../../api/controllers/UserController.php" id="registerFormByAdmin" class="space-y-4">
          ...
          <div class="justify-between flex text-sm font-meduim">
              ...
              <button type="button" id="closeAddModal"  class="cursor-pointer text-white bg-gradient-to-r from-gray-600 via-gray-600 to-gray-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 font-meduim rounded-lg text-sm px-4 py-2 text-center me-2 mb-2">Annuler</button>
