            ...
            <form method="POST" action="../../api/controllers/TuitionController.php" id="registerFormByAdmin" class="space-y-4">
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <input type="text" id="levelName" name="level_name" placeholder="level_name" class="bg-gray-50 mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:border-blue-300" required>
                    </div>
                    <div>
